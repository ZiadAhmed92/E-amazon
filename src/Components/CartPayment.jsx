...
const CartPayment = () => {
  ...
  const { cartProducts, userInfo } = useSelector((state) => state.items)
    ...
    <div className='col-md-3 '>
      <div className='bg-white container-crad p-3'>
        ...
        </span>
        {
         ...
         <> <button
         className="btn btn-info cursor_notAllow w-100 fw-bolder text-white "
       >
         Proceed to Pay
       </button>
       <p className="mx-auto pt-2 text-center text-danger bouncing-element">
